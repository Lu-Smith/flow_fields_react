import ParticleThree from "./ParticleThree";

export default class EffectThree {
    width: number;
    height: number;
    particles: ParticleThree[];
    ...
    context: CanvasRenderingContext2D;
      ...
      drawText() {
        ...
        gradient1.addColorStop(0.8, 'rgb(255, 255, 0)');

        this.context.fillStyle = gradient1;
        this.context.fillText('ABC', this.width * 0.5, this.height * 0.5, this.width * 0.85);
      }
      init() {
        //create flow field
        ...
        for( let i = 0; i < this.numberOfParticles; i++) {
          this.particles.push(new ParticleThree(this));
        }
