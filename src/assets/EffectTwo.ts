...
export default class EffectTwo {
    ...
    context: CanvasRenderingContext2D;
      ...
      drawText() {
        ...
        gradient1.addColorStop(0.2, 'rgb(0, 255, 0)');
        gradient1.addColorStop(0.4, 'rgb(0, 255, 255)');
        gradient1.addColorStop(0.6, 'rgb(0, 0, 255)');
        gradient1.addColorStop(0.8, 'rgb(255, 0, 255)');

        this.context.fillStyle = gradient1;
        this.context.fillText('VAT', this.width * 0.5, this.height * 0.5, this.width * 0.85);
      }
      init() {
        //create flow field
        ...
        for( let i = 0; i < this.numberOfParticles; i++) {
          this.particles.push(new ParticleTwo(this));
        }
