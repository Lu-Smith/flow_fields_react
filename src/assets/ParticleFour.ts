...
export default class ParticleFour {
    x: number;
    y: number;
    effect: EffectFour;
    speedX: number;
    ...
    constructor(effect: EffectFour) {
      ...
      this.maxLength = Math.floor(Math.random() * 16 + 6);
      this.angle = 0;
      this.newAngle = 0;
      this.angleCorrection = Math.random() * 0.8 + 0.01;
      this.timer = this.maxLength * 2;
      this.colors = ['#a61690', '#700d61', '#961717', '#d41717', '#f52727'];
